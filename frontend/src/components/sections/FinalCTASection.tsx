...
const FinalCTASection = memo(() => {
  ...
  <h2 id="final-cta-heading" className="text-3xl font-bold tracking-tight text-neutral-900 sm:text-4xl mb-6">
  ...
  <p className="text-xl text-neutral-900/90 mb-8 max-w-2xl mx-auto">
          ...
          Odpowiadamy tego samego dnia, montujemy w ciągu 1-3 dni.
        </p>

        {/* Main CTAs */}
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
          <Button asChild size="lg" className="text-lg px-8 py-4 bg-white text-neutral-900 hover:bg-neutral-50 rounded-md border border-neutral-200 shadow-sm">
            <a 
          ...
          <Button asChild size="lg" className="text-lg px-8 py-4 bg-transparent text-neutral-900 hover:bg-neutral-900/5 rounded-md border border-neutral-900/30">
            <Link 
              href="/kontakt"
