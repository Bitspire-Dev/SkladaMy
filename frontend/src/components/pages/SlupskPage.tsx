...
export const metadata: Metadata = {
  ...
  description: "⭐ Montaż mebli w Słupsku ✓ Szafy PAX ✓ Kuchnie IKEA ✓ Gwarancja 30 dni ✓ Doświadczenie 300+ realizacji ✓ Dojazd w 24h ✓ Bezpłatna wycena",
  keywords: [
    "montaż mebli Słupsk",
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-20">
            <div className="text-center mb-12">
              ...
              <p className="text-lg sm:text-xl text-neutral-800 max-w-3xl mx-auto leading-relaxed mb-8">
                ⭐ <strong>Profesjonalny montaż mebli IKEA w Słupsku</strong> - 300+ zadowolonych klientów, 
                gwarancja 30 dni, dojazd w 24h. Specjaliści od szaf PAX i kuchni.
              </p>
              
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
                <Button asChild size="lg" className="bg-[#FFC400] text-neutral-900 hover:bg-[#f2b800] shadow-sm">
                  <Link href="/kontakt" aria-label="Przejdź do formularza kontaktowego">
                    <Phone className="mr-2 h-5 w-5" />
                    Bezpłatna wycena - 24h
                  </Link>
                </Button>
                <Button asChild size="lg" variant="outline" className="border-neutral-300 bg-white text-neutral-900 hover:bg-neutral-50">
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {whyUs.map((item, index) => (
                <Card key={index} className="text-center transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-neutral-800 max-w-2xl mx-auto">
                Dojeżdżamy na montaż mebli w całym Słupsku oraz w promieniu 30km od miasta. 
                Dojazd w obrębie miasta jest bezpłatny.
              </p>
            </div>
            ...
            <div className="text-center mt-8">
              <p className="text-sm text-neutral-700">
                Nie widzisz swojej miejscowości? <Link href="/kontakt" className="text-[#6a4a00] hover:underline">Zapytaj nas</Link> - 
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-neutral-800">
                Sprawdź co mówią o nas mieszkańcy Słupska
              </p>
            </div>
            ...
            <div className="text-center mt-8">
              <Button asChild variant="outline" className="border-neutral-300 text-neutral-900 hover:bg-neutral-50">
            ...
            <div className="space-y-6">
              <Card className="transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
                <CardContent className="p-6">
                  ...
                  <p className="text-neutral-800 text-sm">
                    ...
                    Westerplatte, Młodych oraz okoliczne miejscowości jak Kobylnica, Redzikowo czy Ustka.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
                <CardContent className="p-6">
                  ...
                  <p className="text-neutral-800 text-sm">
                    W większości przypadków możemy przyjechać już następnego dnia. 
                    W weekendy i sezonie (wrzesień-listopad) może być potrzeba odczekania 2-3 dni.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
                <CardContent className="p-6">
                  ...
                  <p className="text-neutral-800 text-sm">
                    ...
                    zajmiemy się również meblami z innych sklepów jak Jysk, Black Red White czy BRW.
                  </p>
                </CardContent>
              </Card>
            </div>
          ...
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            <div className="text-center bg-[#FFC400] rounded-2xl p-8">
              ...
              <p className="text-neutral-900/80 mb-6 max-w-2xl mx-auto">
                ...
                Odpowiadamy w ciągu 24h, montaż możliwy już jutro!
              </p>
