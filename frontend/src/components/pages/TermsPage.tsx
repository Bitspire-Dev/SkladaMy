...
export const metadata: Metadata = {
  title: "Regulamin usług montażu mebli 2025 | SkładaMy",
  description:
    "Aktualny (2025) regulamin świadczenia usług montażu mebli IKEA i innych marek – SkładaMy Słupsk. Warunki współpracy, gwarancja 12 miesięcy, reklamacje, odpowiedzialność, RODO.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Warunki współpracy z firmą montażową SkładaMy: zakres usług, gwarancja 12 miesięcy, reklamacje, RODO, odpowiedzialność – aktualizacja 2025.",
    type: "website",
...
export default function TermsPage() {
  const sections = [
    {
      ...
      keywords: "zakres usług, kontakt, Słupsk",
    },
    {
      id: "zakres-uslug",
      title: "§2 Zakres usług montażowych",
      keywords: "IKEA, PAX, montaż mebli",
    },
    {
      id: "zamawianie-uslug",
      title: "§3 Zamawianie usług i wyceny",
      keywords: "wycena, terminy, kontakt",
    },
    ...
    {
      id: "gwarancja",
      title: "§6 Gwarancja jakości montażu",
      keywords: "12 miesięcy, gwarancja, jakość",
    },
  ...
  const regulaminStructuredData = {
    ...
    description:
      "Aktualny regulamin świadczenia usług montażu mebli (IKEA, PAX, kuchnie) – warunki współpracy, gwarancja, reklamacje, odpowiedzialność, RODO.",
    url: `${siteUrl}/regulamin`,
    inLanguage: "pl-PL",
    ...
    mainEntity: {
      ...
      description:
        "Dokument określający zasady świadczenia usług montażu mebli dla klientów w regionie Słupska.",
      dateModified: new Date().toISOString(),
      author: {
        "@type": "Organization",
      ...
      legislationApplies:
        "Kodeks cywilny; Ustawa o prawach konsumenta; Ustawa o świadczeniu usług drogą elektroniczną; RODO",
    },
    breadcrumb: {
      "@type": "BreadcrumbList",
      itemListElement: [
          ...
          <div className="space-y-8">
            <Card id="postanowienia-ogolne">
              <CardHeader>
                <CardTitle className="group scroll-mt-24">
                  ...
                  <a
                    ...
                    aria-label="Link do tego paragrafu"
                  >
                    #
                  </a>
                </CardTitle>
              ...
              <CardContent className="space-y-4">
                ...
                <p className="text-muted-foreground text-sm">
                  2. Firma specjalizuje się w profesjonalnym montażu mebli wszystkich marek, ze
                  szczególnym uwzględnieniem mebli IKEA, w Słupsku i okolicach.
                </p>
                <p className="text-muted-foreground text-sm">
                ...
                <p className="text-muted-foreground text-sm">
                  4. Akceptacja niniejszego regulaminu następuje z chwilą złożenia zamówienia na
                  usługi montażu mebli. W przypadku pytań zapoznaj się z naszym
            ...
            <Card id="zakres-uslug">
              ...
              <CardContent className="space-y-4">
                ...
                <ul className="text-muted-foreground text-sm space-y-1 ml-4">
                  <li>
                    • <strong>Montaż mebli IKEA:</strong> szafy PAX, kuchnie, łóżka, komody, regały
                    BILLY
                  </li>
                  <li>
                    • <strong>Składanie mebli innych marek:</strong> Black Red White, Agata Meble,
                    Jysk
                  </li>
                  <li>
                    • <strong>Montaż mebli łazienkowych:</strong> szafki, lustrzane fronty,
                    oświetlenie
                  </li>
                  <li>
                    • <strong>Instalacja mebli kuchennych:</strong> szafki, blaty, zlewozmywaki
                  </li>
                  <li>
                    • <strong>Montaż systemów przechowywania:</strong> szafy wnękowe, garderoby
                  </li>
                  <li>
                    • <strong>Wieszanie elementów ściennych:</strong> półki, uchwyty TV, lustra
                  </li>
                  <li>
                    • <strong>Kotwienie mebli:</strong> zabezpieczenie antyporadowe, mocowanie do
                    ściany
                  </li>
                  <li>
                    • <strong>Regulacja i dokręcanie:</strong> zawiasów, szuflad, drzwiczek
                  </li>
                </ul>
                <p className="text-muted-foreground text-sm">
                ...
                <p className="text-muted-foreground text-sm">
                  3. Usługodawca <strong>nie wykonuje</strong> instalacji wykraczających poza
                  standardowy montaż mebli:
                </p>
                <ul className="text-muted-foreground text-sm space-y-1 ml-4">
            ...
            <Card id="zamawianie-uslug">
              ...
              <CardContent className="space-y-4">
                ...
                <p className="text-muted-foreground text-sm">3. Wycena może ulec zmianie gdy:</p>
                <ul className="text-muted-foreground text-sm space-y-1 ml-4">
                ...
                <p className="text-muted-foreground text-sm">
                  4. <strong>Terminy montażu:</strong> standardowo 1-3 dni robocze w Słupsku, pilne
                  zlecenia możliwe tego samego dnia (dopłata 20%). Zobacz więcej o naszej
                  <Link href="/o-nas" className="text-primary hover:underline">
                    firmie i doświadczeniu
                  </Link>
                  .
                </p>
              </CardContent>
            ...
            <Card id="realizacja-uslug">
              ...
              <CardContent className="space-y-4">
                ...
                <p className="text-muted-foreground text-sm">3. Klient zobowiązany jest do:</p>
                <ul className="text-muted-foreground text-sm space-y-1 ml-4">
            ...
            <Card id="platnosci">
              ...
              <CardContent className="space-y-4">
                ...
                <p className="text-muted-foreground text-sm">2. Akceptowane formy płatności:</p>
                <ul className="text-muted-foreground text-sm space-y-1 ml-4">
                  <li>• Gotówka</li>
                ...
                <p className="text-muted-foreground text-sm">
                  4. W przypadku płatności przelewem, termin płatności wynosi 7 dni od daty
                  wystawienia faktury.
                </p>
              </CardContent>
            </Card>
            ...
            <Card id="gwarancja">
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground text-sm">
                  1. <strong>Gwarancja montażu:</strong> Usługodawca udziela 12-miesięcznej
                  gwarancji na jakość wykonanego montażu mebli.
                </p>
                <p className="text-muted-foreground text-sm">
                ...
                <p className="text-muted-foreground text-sm">
                  3. <strong>Gwarancja dodatkowa na kotwienia:</strong> 24 miesiące gwarancji na
                  mocowanie mebli do ściany i instalacje antyporadowe.
                </p>
                <p className="text-muted-foreground text-sm">
                ...
                <p className="text-muted-foreground text-sm">
                  5. <strong>Procedura gwarancyjna:</strong> Zgłoszenia przyjmowane telefonicznie
                  lub mailowo, czas realizacji: do 7 dni roboczych od zgłoszenia. Szczegóły
                  procedury reklamacyjnej znajdziesz w{" "}
                  <a href="#reklamacje" className="text-primary hover:underline">
                    §8 Reklamacje
                  </a>
                  .
                </p>
            ...
            <Card id="odpowiedzialnosc">
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground text-sm">
                  1. Usługodawca posiada ubezpieczenie odpowiedzialności cywilnej na kwotę 100 000
                  zł.
                </p>
                <p className="text-muted-foreground text-sm">
                  2. Odpowiedzialność Usługodawcy ograniczona jest do wysokości szkody, nie więcej
                  jednak niż wartość wykonanej usługi.
                </p>
                <p className="text-muted-foreground text-sm">
            ...
            <Card id="rodo">
              ...
              <CardContent className="space-y-4">
                ...
                <p className="text-muted-foreground text-sm">
                  ...
                  klientem, wystawienie dokumentów księgowych.
                </p>
                <p className="text-muted-foreground text-sm">
                  3. <strong>Podstawa prawna:</strong> wykonanie umowy, realizacja obowiązków
                  prawnych, uzasadniony interes administratora.
                </p>
                <p className="text-muted-foreground text-sm">
                  4. <strong>Zakres danych:</strong> imię, nazwisko, adres, telefon, e-mail, dane do
                  faktury (w przypadku firm: NIP, REGON).
                </p>
                <p className="text-muted-foreground text-sm">
                  5. <strong>Okres przechowywania:</strong> przez czas realizacji usługi oraz przez
                  okres wymagany prawem (rachunkowość: 5 lat).
                </p>
                <p className="text-muted-foreground text-sm">
                  6. <strong>Prawa klienta:</strong> dostęp, sprostowanie, usunięcie, ograniczenie,
                  przenośność danych, sprzeciw, cofnięcie zgody. Szczegółowe informacje znajdziesz w
                  naszej
                  <Link href="/polityka-prywatnosci" className="text-primary hover:underline ml-1">
            ...
            <Card id="postanowienia-koncowe">
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground text-sm">
                  ...
                  cywilnego oraz innych właściwych ustaw.
                </p>
                <p className="text-muted-foreground text-sm">
                  2. <strong>Rozstrzyganie sporów:</strong> strony będą dążyć do polubownego
                  rozwiązania sporów. W przypadku braku porozumienia właściwy jest sąd dla miejsca
                  wykonywania usługi.
                </p>
                <p className="text-muted-foreground text-sm">
                ...
                <p className="text-muted-foreground text-sm">
                  ...
                  postanowień, pozostałe zachowują moc obowiązującą.
                </p>
                <p className="text-muted-foreground text-sm">
                  5. Regulamin wchodzi w życie z dniem publikacji i ma zastosowanie do wszystkich
                  zleceń złożonych po tej dacie.
                </p>
              </CardContent>
            </Card>
